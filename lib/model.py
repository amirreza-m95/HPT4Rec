...
class GRU4REC(nn.Module):
    ...
    def forward(self, input, hidden):
        ...
        if self.embedding_dim == -1:
            ...
            embedded = embedded.unsqueeze(0) #Returns a new tensor with a dimension of size one inserted at the specified position.
        else:
        ...
        logit = self.final_activation(self.h2o(output)) # Logits interpreted to be the unnormalised (or not-yet normalised) predictions (or outputs) of a model.
